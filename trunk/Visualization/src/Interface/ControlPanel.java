...
public class ControlPanel extends JPanel
{
	...
	{	System.out.println("set to "+newIndex);
		return selectTime.setArchiveIndex(newIndex); }
	...
	{	return thelimits.adjustLimits(dmin,dmax,docCtrl.movieFrame.plotView.dataMin,
					docCtrl.movieFrame.plotView.dataMax,docCtrl.movieFrame.plotView.dataLimitsSet);
	}
