...
bool BodyPolyhedronController::Is2DBodyObject(void) { return FALSE; }
...
bool BodyPolyhedronController::SetBodyPropertyFromData(char *bData,CommonReadHandler *reader)
{
	int i;
	vector<double> pts;
	Vector box[8];
