...
enum { UNKNOWN_QUANTITY,AVG_SXX,AVG_SYY,AVG_SXY,AVG_SZZ,AVG_SXZ,AVG_SYZ,
			...
			KINE_ENERGY,STRN_ENERGY,TOTL_ENERGY,EXTL_WORK,POTL_ENERGY,PLAS_ENERGY,
			AVG_VELX,AVG_VELY,AVG_VELZ,TOTL_THERMALENERGY,AVG_TEMP,
			AVG_DISPX,AVG_DISPY,AVG_DISPZ,WTFRACT_CONC,STEP_NUMBER,CPU_TIME,ELAPSED_TIME,
			FEEDBACK_ALPHA,INTERFACE_ENERGY,HISTORY_VARIABLE,TOT_FCONX,TOT_FCONY,TOT_FCONZ,
			HEAT_ENERGY,GRID_KINE_ENERGY};
